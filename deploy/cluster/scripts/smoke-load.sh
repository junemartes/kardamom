...
#       executor  kardamom-w1  127.0.0.1:9004  kardamom_executor_block_number
#       sealer    kardamom-w2  127.0.0.1:9003  kardamom_sealer_block_number
#
# ---------------------------------------------------------------------------
# ENV KNOBS (all optional; sane defaults)
# ---------------------------------------------------------------------------
#   RPC_URL            ingress JSON-RPC          (default http://192.168.56.21:8545)
...
#                                                 (default "kardamom-w1")
#   SEALER_NODE        node-container running the sealer (default kardamom-w2)
...
EXECUTOR_NODES="${EXECUTOR_NODES:-kardamom-w1}"
SEALER_NODE="${SEALER_NODE:-kardamom-w2}"
