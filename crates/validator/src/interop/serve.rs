...
/// The subscription loop for the attestation feed: cursor-honoring backfill
...
/// place the per-item loop needs to nest inside the outer scan-and-wait
/// loop.
