...
pub struct ChannelsConfig {
    ...
    /// `tx_dattx_dattx_dattx_dattx_dattx_data_stream_id_base + sequencer_id`.
    pub tx_dattx_dattx_dattx_dattx_dattx_data_channel_template: String,
    pub tx_dattx_dattx_dattx_dattx_dattx_data_stream_id_base: i32,
    ...
    /// `fsync_watermark_tx_dattx_dattx_dattx_dattx_dattx_data_stream_id_base + sequencer_id`.
    pub fsync_watermark_tx_dattx_dattx_dattx_dattx_dattx_data_channel_template: String,
    pub fsync_watermark_tx_dattx_dattx_dattx_dattx_dattx_data_stream_id_base: i32,
...
impl ChannelsConfig {
    ...
    pub fn a_channel(&self, sequencer_id: u8) -> String {
        self.tx_dattx_dattx_dattx_dattx_dattx_data_channel_template
            .replace("{sid}", &sequencer_id.to_string())
    }

    /// TxData[i] stream id (`tx_dattx_dattx_dattx_dattx_dattx_data_stream_id_base + sequencer_id`).
    pub fn a_stream_id(&self, sequencer_id: u8) -> i32 {
        self.tx_dattx_dattx_dattx_dattx_dattx_data_stream_id_base + sequencer_id as i32
    }
    ...
    pub fn fsync_watermark_a_channel(&self, sequencer_id: u8) -> String {
        self.fsync_watermark_tx_dattx_dattx_dattx_dattx_dattx_data_channel_template
            .replace("{sid}", &sequencer_id.to_string())
    }

    /// Per-sequencer tx_data fsync watermark stream id.
    pub fn fsync_watermark_a_stream_id(&self, sequencer_id: u8) -> i32 {
        self.fsync_watermark_tx_dattx_dattx_dattx_dattx_dattx_data_stream_id_base
            + sequencer_id as i32
    }
}
    ...
    fn default() -> Self {
        Self {
            ...
            channels: ChannelsConfig {
                tx_dattx_dattx_dattx_dattx_dattx_data_channel_template: "aeron:ipc?alias=a-{sid}"
                    .into(),
                tx_dattx_dattx_dattx_dattx_dattx_data_stream_id_base: 2000,
                ...
                fsync_watermark_tx_dattx_dattx_dattx_dattx_dattx_data_channel_template:
                    "aeron:ipc?alias=fsync-wm-a-{sid}".into(),
                fsync_watermark_tx_dattx_dattx_dattx_dattx_dattx_data_stream_id_base: 1030,
