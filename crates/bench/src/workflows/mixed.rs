...
use crate::signers::{SignerSet, presign_transfers};
...
impl MixRatio {
    ...
    #[must_use]
    pub fn new(transfers: u32, calls: u32) -> Option<Self> {
...
impl Default for MixedWorkflow {
    fn default() -> Self {
        Self {
            ...
            ratio: MixRatio::new(1, 4).expect("1 transfer + 4 calls is a valid ratio"),
        }
    }
}
