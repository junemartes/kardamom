...
pub struct BenchArgs {
    ...
    #[arg(long, default_value_t = NonZeroU32::new(DEFAULT_CONCURRENCY).expect("DEFAULT_CONCURRENCY != 0"))]
    ...
    #[arg(long = "txs-per-task", default_value_t = NonZeroU32::new(DEFAULT_TXS_PER_TASK).expect("DEFAULT_TXS_PER_TASK != 0"))]
