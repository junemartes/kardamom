...
/// carry an unbounded wire `gas_limit`, and the add below would wrap it
/// silently in a release build (no `overflow-checks`). Taking
...
pub(super) fn tx_env_from_xchain(
    ...
    TxEnv {
        ...
        gas_limit: message.gas_limit + super::xchain::XCHAIN_DELIVERY_OVERHEAD,
        gas_price: 0,
        nonce: 0,
        chain_id: None,
        ..Default::default()
