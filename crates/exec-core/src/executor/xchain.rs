...
///   `MAX_MESSAGE_GAS` (158_730 gas),
/// - `Inbox.RESERVE` (200_000 gas): the bounded return copy, the status
...
///   25_800 gas).
///
/// Measured need: 384_484 gas. Pinned at 1.2 times that, rounded up. Must
...
pub const XCHAIN_DELIVERY_OVERHEAD: u64 = 462_000;
