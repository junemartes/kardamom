...
//! validator share: `decode_alloy_envelope`, then `tx_env_from_alloy`,
//! then [`ExecScope::execute_tx`], under the fixture's block and cfg env
//! (through [`ExecScope::new_with_envs`]). It then checks the resulting
