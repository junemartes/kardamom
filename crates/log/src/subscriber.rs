...
pub type TxDepositsSubscriber = TypedSubscriber<Deposit>;
...
impl Subscribers {
    ...
    pub fn tx_deposits(&self) -> Result<TxDepositsSubscriber, LogError> {
        TypedSubscriber::open(
            &self.aeron,
            &self.ch.tx_deposits_channel,
            self.ch.tx_deposits_stream_id,
        )
    }
