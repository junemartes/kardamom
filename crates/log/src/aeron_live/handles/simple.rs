...
//! TxDeposits, TxRemoteEpochs, FsyncWatermark, Quorum. Each is a publisher wrapping one
...
//! is stamped out by [`declare_channel_handles!`]. The public type-name pairs
//! and their method signatures are exactly what the hand-written copies
//! exposed.
