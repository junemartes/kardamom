...
use kardamom_types::xchain::{
    OutboxMessage, RemoteEpochRecord, derive_remote_epoch, remote_source_hash,
};
...
use kardamom_da_watcher::interop::{
    CursorFile, InteropError, InteropWatcherConfig, process_once, spawn,
};
...
fn msg(seq: u64, block: u64) -> OutboxMessage {
    OutboxMessage {
        ...
        origin_block_hash: B256::repeat_byte(u8::try_from(block).unwrap()),
        dest_chain_id: SELF,
        seq,
